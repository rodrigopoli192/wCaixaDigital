...
# Fix: Use FileHandler instead of TimedRotatingFileHandler on Windows to avoid PermissionError
LOGGING["handlers"]["file_json"] = {  # noqa: F405
    "class": "logging.FileHandler",
    "filename": BASE_DIR / "logs" / "app.json.log",  # noqa: F405
    "encoding": "utf-8",
    "formatter": "json",
